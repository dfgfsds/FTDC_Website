                ...
                <div className="w-full rounded-2xl overflow-hidden relative">
                    ...
                    <div className="absolute inset-0 z-[2] mx-80p 3xl:pt-[125px] xxl:pt-28 xl:pt-25 md:pt-12 pt-8">
                        <div className="max-w-[790px]">
                            ...
                            <h1 className="font-squares hidden md:block display-120 text-3xl md:text-7xl lg:text-8xl stroked-text-1 line-clamp-2 mb-2">
                                Gaming PC Shop in Chennai
                            </h1>

                            <h2 className="font-squares md:hidden display-120 text-3xl md:text-6xl lg:text-7xl  line-clamp-2 mb-2">
                                Gaming PC Shop in Chennai
                            </h2> 

                            <p className="text-m-medium mb-4 text-w-neutral-1">
                                Custom Gaming PC Built for Performance
                            </p>

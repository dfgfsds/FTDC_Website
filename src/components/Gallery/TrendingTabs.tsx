    ...
    return (
        <section className="pt-30p px-8 md:px-32">
            <div className="section-pt">
                ...
                {/* Tabs */}
                <div className="overflow-x-auto scrollbar-hide mb-6 mt-10">
                        ...
                        {tabs.map((tab) => (
                            <button
                                ...
                                className={`relative flex-shrink-0 px-4 py-2 font-semibold transition-all whitespace-nowrap ${activeTab === tab.id
                                    ? "text-[#ff340c] border-b-2 border-[#ff340c]"
                                    : "text-gray-500 hover:text-[#ff340c]"
                                    }`}
                            >
                                {tab.label}
                            </button>
                    ...
                    {Array.from({ length: totalPages }, (_, i) => (
                        <button
                            ...
                            className={`px-3 sm:px-4 py-2 rounded-full font-semibold transition ${page === i + 1
                                ? "bg-[#ff340c] text-white shadow-lg"
